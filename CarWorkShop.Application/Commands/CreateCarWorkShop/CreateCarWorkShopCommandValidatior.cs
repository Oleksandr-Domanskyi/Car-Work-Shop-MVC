...
{
    public class CreateCarWorkShopCommandValidatior : AbstractValidator<CreateCarWorkShopCommand>
    {
        public CreateCarWorkShopCommandValidatior(ICarWorkShopRepository repository)
        {
            RuleFor(c => c.Name)
                .NotEmpty()
